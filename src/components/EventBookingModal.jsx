...
const EventBookingModal = ({ 
    ...
    return (
        <div className="fixed inset-0 z-[1000] flex items-start justify-center p-4 bg-navy-950/60 backdrop-blur-sm animate-fade-in overflow-y-auto pt-28">
            <div className="bg-white w-full max-w-4xl rounded-[2.5rem] shadow-2xl overflow-hidden animate-scale-in mb-10 flex flex-col">
                {/* Header */}
                <div className="p-8 text-white flex justify-between items-center flex-shrink-0" style={{ background: 'linear-gradient(135deg, #0f172a, #1e293b)' }}>
                    <div>
                ...
                <div className="p-8">
                    <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                        ...
                        <div className="lg:col-span-1">
                            <div className="lg:sticky lg:top-0 bg-navy-900 rounded-[2rem] p-6 text-white shadow-xl">
                                ...
                                <div className="space-y-4 mb-8">
                                    ...
                                    <div className="bg-white/5 rounded-2xl p-4 mt-6 space-y-3">
                                        ...
                                        {paymentType === 'deposit' && (
                                            <>
                                                <div className="flex justify-between items-center border-t border-white/10 pt-2">
                                                    <span className="text-xs text-white/60 font-medium italic">Due Amount</span>
                                                    <span className="text-sm font-bold text-amber-300 italic">Rs. {(eventData.totalAmount - advanceAmount).toLocaleString()}</span>
                                                </div>
                                                <p className="text-[10px] text-amber-300 font-bold uppercase tracking-widest text-center mt-1">
