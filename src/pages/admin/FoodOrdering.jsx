    ...
    const handleSubmit = async (e) => {
        ...
        try {
            if (isEditing) {
                ...
                setMenuItems((prev) => prev.map((item) => (item._id === currentId ? updatedItem : item)));
            ...
            <div className="bg-white p-4 rounded-xl shadow-sm border border-navy-100 flex flex-col md:flex-row gap-4 items-center">
                ...
                <div className="flex items-center gap-2 w-full md:w-auto">
                    ...
                    <select
                        ...
                        className="border border-navy-200 rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500 bg-white"
                    >
                ...
                {filteredMenuItems.length > 0 ? (
                    filteredMenuItems.map((item) => (
                        <div key={item._id} className="bg-white rounded-2xl shadow-sm border border-navy-100 overflow-hidden hover:shadow-lg transition-all duration-300 group">
                            <div className={`h-40 flex items-center justify-center overflow-hidden text-6xl bg-linear-to-br ${item.status === 'Available' ? 'from-blue-50 to-blue-100' : 'from-gray-100 to-gray-200'}`}>
                            ...
                            <div className="p-5">
                                ...
                                <div className="flex flex-col mt-2">
                                    <div className="flex items-center gap-2">
                                        <p className="text-2xl font-bold text-blue-600">Rs. {(item.sellingPrice || item.price || 0).toFixed(2)}</p>
                                        {item.discount > 0 && (
                                    ...
                                    <p className="text-[10px] text-navy-400 font-medium">Prod: Rs. {(item.productionPrice || 0).toFixed(2)}</p>
                                </div>
                    ...
                    <div className="col-span-full bg-white rounded-2xl border border-dashed border-navy-200 p-10 text-center text-navy-500">
            ...
            {isModalOpen && (
                <div className="fixed inset-0 bg-black/50 flex items-center justify-center z-200 p-4">
                    <div className="bg-white rounded-2xl w-full max-w-md shadow-2xl overflow-hidden flex flex-col max-h-[90vh]">
                        <div className="p-6 border-b border-navy-100 shrink-0">
